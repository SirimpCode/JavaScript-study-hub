 ...
 */
 ...
 window.onload = function(){
		...
		document.getElementById("val2").innerHTML = Math.ceil(10/4); // 2.5 보다 큰 최소의 정수  ==> 3  걍 올림
		
		document.getElementById("val3").innerHTML = Math.ceil(10/5); // 2  소수부가 없는 정수라면 그대로 정수가 나오므로 2 이다.  
		
		document.getElementById("val4").innerHTML = Math.floor(10/4); // 2.5 보다 작은 최대의 정수  ==> 2 내림
		...
		document.getElementById("val8").innerHTML = Math.round(10/4); // 2.5를 반올림 해준다. 3  반올림
